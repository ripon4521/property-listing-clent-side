    ...
    return (
       <div className="bg-[#F7F7FC] py-5 mt-10">
         <div className="max-w-7xl mx-auto mt-20 ">
            <div className="px-5">
            <h1 className="text-4xl font-bold font-opanSans drop-shadow-md flex items-center">Explore the <span className="text-yellow-400 px-2">UAE</span> market <FcIdea className="text-5xl"/></h1>
