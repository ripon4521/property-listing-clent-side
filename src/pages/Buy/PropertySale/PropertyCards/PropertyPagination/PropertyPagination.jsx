    ...
    return (
        <div className="flex justify-around items-center">
            ...
            <ul className="flex justify-center items-center gap-2 md:gap-5">
                <li className="px-3  py-2 cursor-pointer rounded-md border border-[#3A307F] text-white bg-[#3A307F] ">1</li>
                ...
                <li className="px-3 hover:bg-gray-300 py-2 cursor-pointer rounded-md border border-[#3A307F] text-[#3A307F]  hidden md:block ">7</li>
                <li className="px-3 hover:bg-gray-300 py-2 cursor-pointer rounded-md border border-[#3A307F] text-[#3A307F]  hidden md:block">8</li>
                <li className="px-3 hover:bg-gray-300 py-2 cursor-pointer rounded-md border border-[#3A307F] text-[#3A307F]  hidden md:block">9</li>
                <li className="px-3 hover:bg-gray-300 py-2 cursor-pointer rounded-md border border-[#3A307F] text-[#3A307F]  hidden md:block">10</li>
            </ul>
